...
(function ($, window, undefined) {
    ...
    $.widget('comiseo.daterangepicker', {
        ...
        options: {
            ...
            menuselect: null, // callback that executes when a preset value is selected
...
//				showCurrentAtPos: 1 // bug; use maxDate instead
    ...
    function buildDateRangePicker($originalElement, instance, options) {
        ...
        function formatRange(range) {
            ...
            formattedRange.presetId = range.presetId;
        ...
        function usePreset(event) {
            ...
            calendar.setRange({start: start, end: end, presetId: presetId});
            ...
            instance._trigger('menuselect', event, {instance: instance, preset: $this});
